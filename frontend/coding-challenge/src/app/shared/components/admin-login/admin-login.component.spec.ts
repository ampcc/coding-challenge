...
describe('AdminLoginComponent', () => {
  ...
  it('error message for username hidden on default', () => {
    const error = !fixture.debugElement.query(By.css('.username_error')).nativeElement.classList.contains('no_error');
  ...
  it('error message for password hidden on default', () => {
    const error = !fixture.debugElement.query(By.css('.password_error')).nativeElement.classList.contains('no_error');
